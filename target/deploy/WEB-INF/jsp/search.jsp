 ...
 Services
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="form-group">
      <label for="id"><h1>Search drug by ID   :</h1></label>
  ...
  <form name="searchDrugs" model="searchModel" action="/webportal/searchDrugByName" method="post">
   <div class="form-group">
      <label for="id"><h1>Search drug by Name :</h1></label>
   ...
   INFO
     ...
     <tbody>
         ...
         <tr ><td> <h6> ID : ${drugdetails.drugId}</h6> </td></tr>
           <tr><td> <h6>NAME : ${drugdetails.drugName}</h6> </td></tr>
           <tr><td> <h6>MANUFACTURER : ${drugdetails.manufacturer}</h6> </td></tr>
            <tr><td><h6>MANUFACTURE DATE : ${drugdetails.manufactureDate}</h6></td></tr>
            <tr><td><h6>EXPIRY DATE : ${drugdetails.expiryDate}</h6></td></tr>
            <tr><td><c:forEach items="${drugdetails.druglocationQuantities}" var="itr1">
                   <p> QUANTITY : ${itr1.location} : ${itr1.quantity}</p><br>
            </c:forEach>
            </td>
        </div>
    </section>
